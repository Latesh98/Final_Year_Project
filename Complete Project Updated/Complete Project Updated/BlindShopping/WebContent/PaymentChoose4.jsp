										...
										<form id="labnol" name="ureg" method="get"
											...
											<input type="text" value="<%=year %>">
												<input type="text" placeholder="CVV Number"
													name="cvv" id="transcript" onblur="return getData()"
													maxlength="3">
												<script>
													function getData() {
														var text = document.ureg.cvv.value;
														//		alert(text);
														window.location = "PlaceOrder.jsp?paymenttype=online&pid="
															+ text;

							...
							<div class="pageform">
								<div class="table-responsive">
									...
									<table class="table "
										style="width: 100%; margin: 0; border: 1px solid #fff; color: #82e0aa; font-size: 15px">
										<%
												//			msg.talk("Please tell us your card month");
										%>
										...
										<form id="labnol" name="ureg" method="get"
											...
											<input type="text" value="<%=cardno %>">
												<input type="text" placeholder="Your Month"
													name="month" id="transcript" onblur="return getData()"
													maxlength="2">
												<script>
													function getData() {
														var text = document.ureg.month.value;
														//		alert(text);
														window.location = "PaymentChoose3.jsp?month="
																+ text;
